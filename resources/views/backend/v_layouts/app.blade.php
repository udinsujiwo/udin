            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <span class="logo-text">
                            <!-- dark Logo text -->
                            <!-- Risa Edit Icon => nama icon logo_text.png bukan logo-text.png -->
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <!-- ============================================================== -->
                        <!-- Risa Edit icon =>Script awal: src="assets/images/users/1.jpg" -->
                        <!-- dirubah dl jadi ini"{{ asset('backend/images/users/1.jpg')}}" -->
...
waves-dark sidebar-link" href="{{ route('backend.user.index') }}" aria-expanded="false"><i
    ...
    <script>
        function previewFoto() {
            ...
            if (foto.files && foto.files[0]) { // Pastikan ada file
